...
local_icon <- function(png_file,Width="50px") {
  
  apputils::icon(list(src=png_file,width=Width),lib="local")
  }

#latest_data_download <- 'data/Formulario Nuevo Proyecto - Meals 4 Hope_19 diciembre 2019_07.30.xlsx'

latest_data_download <- 'data/Formulario Nuevo Proyecto - Meals 4 Hope_20 febrero 2020_13.40.xlsx'
